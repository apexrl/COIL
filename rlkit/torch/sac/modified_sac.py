...
class SoftActorCritic(Trainer):
    ...
    def train_step(self, batch, **kwargs):
        ...
        if training_mode is None or training_mode == "sac":
            ...
            q_extra_loss = [self._lambda * torch.mean((_q_pred - _q_target.detach()) ** 2) for _q_pred in _qfs_pred]
            ...
            q_loss_mean = q_extra_loss_mean + q_extra_loss_mean
