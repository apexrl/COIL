...
from rlkit.torch.sac.modified_sac_dis import SoftActorCritic
from rlkit.torch.phase_offline.phase_offline_dis import PhaseOffline
...
def experiment(variant, **kwargs):
    ...
    if snapshot is not None:
        algorithm.running_mean = snapshot.get("filter", algorithm.running_mean)
